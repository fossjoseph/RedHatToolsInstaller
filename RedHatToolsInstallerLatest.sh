...
# https://redhatsatellite.github.io/
...
echo "*************************************************************"
	...
	#subscription-manager attach --pool=`subscription-manager list --available --matches 'Red Hat Enterprise Linux Server' --pool-only`
   	...
   	yum -q list installed yum-utils &>/dev/null && echo "yum-utils  is installed" || yum install -y yum-util*  --skip-broken
    	...
    	subscription-manager repos --enable=rhel-7-server-rpms --enable=rhel-7-server-extras-rpms  --enable=rhel-7-server-optional-rpms  --enable=rhel-7-server-rpms
...
subscription-manager repos --enable=rhel-7-server-extras-rpms --enable=rhel-7-server-optional-rpms --enable=rhel-7-server-rh-common-rpms --enable=rhel-7-server-rhn-tools-rpms --enable=rhel-7-server-rpms --enable=rhel-server-rhscl-7-rpms --enable=rhel-7-server-satellite-6.2-rpms --enable=rhel-7-server-satellite-capsule-6.2-rpms --enable=rhel-7-server-satellite-tools-6.2-rpms --enable=rhel-server-rhscl-7-rpms
sleep 20
...
echo "*********************************************************"
gnome-terminal -e "tail -f /var/log/messages | egrep -v 'clipboard' 'slice' "
subscription-manager repos --enable=rhel-7-server-satellite-6.1-rpms --enable=rhel-7-server-satellite-6.0-rpms
...
subscription-manager repos --disable=rhel-7-server-satellite-6.1-rpms --disable=rhel-7-server-satellite-6.0-rpms
